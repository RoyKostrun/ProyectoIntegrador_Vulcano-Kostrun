...
// ✅ Servicio para manejar fotos de perfil

import 'dart:io';
import 'package:flutter/foundation.dart' show kIsWeb;
import 'package:flutter/material.dart'; // ✅ AGREGADO - imports de Flutter
...
class FotoService {
  ...
  Future<String?> subirFotoPerfil(XFile imageFile) async {
    try {
      ...
      final fileName = '${authUser.id}/$timestamp.$extension'; // ✅ Usar authUser.id
  ...
  // ==============================================================
  // 🔹 ACTUALIZAR URL DE FOTO EN BASE DE DATOS
  // ==============================================================
  Future<void> actualizarFotoPerfilEnBD(String fotoUrl) async {
    try {
      ...
      print('✅ URL de foto actualizada en BD');
    } catch (e) {
