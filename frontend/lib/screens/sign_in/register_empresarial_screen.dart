...
class RegisterEmpresarialScreen extends StatefulWidget {
  ...
  @override
  State<RegisterEmpresarialScreen> createState() =>
      _RegisterEmpresarialScreenState();
}
...
class _RegisterEmpresarialScreenState extends State<RegisterEmpresarialScreen> {
  ...
  final _provinciaController =
      TextEditingController(); // ✅ REORDENADO: Provincia primero
  final _ciudadController =
      TextEditingController(); // ✅ REORDENADO: Ciudad segundo
  ...
  String? _validateCUIT(String value) {
    ...
    if (!RegExp(r'^[0-9]+$').hasMatch(cleanCuit))
      return 'CUIT debe contener solo números';
  ...
  void _validateInformacionContacto() {
    ...
    setState(() {
      ...
      _informacionContactoCompleta =
          _errorTelefono == null && _telefonoController.text.trim().isNotEmpty;
    });
  }
  ...
  void _validateInformacionUbicacion() {
    ...
    setState(() {
      _errorNombreUbicacion = Validators.validateRequired(
          _nombreUbicacionController.text, 'Nombre ubicación');
      _errorProvincia =
  ...
  Future<void> _register() async {
    ...
    try {
      ...
      // ✅ NAVEGAR SIN USAR mounted - Usar addPostFrameCallback
                  ...
                  TextFormField(
                    ...
                    inputFormatters: [
                      FilteringTextInputFormatter.allow(
                          RegExp(r'[0-9\-]')), // Solo números y guiones
                    ...
                    decoration: InputDecoration(
                      ...
                      counterText:
                          '${_cuitController.text.replaceAll(RegExp(r'[-\s]'), '').length}/11',
              ...
              SectionContainer(
                ...
                children: [
                  ...
                  CustomTextField(
                    ...
                    enabled: _datosEmpresaCompletos,
                    suffixIcon: _datosEmpresaCompletos
                        ? IconButton(
                            icon: Icon(
                              _obscurePassword
                                  ? Icons.visibility
              ...
              SectionContainer(
                ...
                children: [
                  CustomTextField(
                    ...
                    hintText:
                        'Nombre de la ubicación (ej: Sede Central, Oficina)',
                  ...
                  CustomTextField(
                    ...
                    isDropdown: true,
                    options: ProvincesCities.getCitiesByProvince(
...
class _CUITInputFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    if (text.length <= 2) {
      ...
      String formatted =
          '${text.substring(0, 2)}-${text.substring(2, 10)}-${text.substring(10)}';
      return newValue.copyWith(
        text: formatted,
        selection: TextSelection.collapsed(offset: formatted.length),
      );
